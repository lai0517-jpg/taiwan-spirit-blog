...
export const taiwanSpiritRegions: TaiwanSpiritRegion[] = [
  {
    ...
    placeLabels: ['台北市', '新北市', '基隆市', '桃園市北段', '淡水河', '基隆河', '新店溪', '大漢溪', '鶯歌'],
  ...
  },
  {
    ...
    placeLabels: ['桃園市南段', '新竹縣', '新竹市', '苗栗縣', '三義', '龍騰', '火炎山', '鯉魚潭', '台三線'],
  ...
  },
  {
    ...
    placeLabels: ['台中市', '彰化縣', '南投縣', '雲林縣', '濁水溪', '大甲溪', '烏溪', '八卦山', '埔里'],
  ...
  },
  {
    ...
    placeLabels: ['嘉義縣', '嘉義市', '台南市', '高雄市', '屏東縣', '府城', '西拉雅平原', '曾文溪', '高屏溪', '南部海口'],
  ...
  },
  {
    ...
    placeLabels: ['宜蘭縣南段', '花蓮縣', '台東縣', '花東縱谷', '海岸山脈', '中央山脈東側', '秀姑巒溪', '卑南溪'],
  ...
  },
  {
    ...
    placeLabels: ['中央山脈', '雪山山脈', '玉山山脈', '阿里山', '合歡山', '大霸尖山', '梨山', '霧社', '高山溪谷'],
  ...
  },
  {
    ...
    placeLabels: ['澎湖縣', '金門縣', '連江縣／馬祖', '蘭嶼', '綠島', '小琉球', '東沙', '南沙', '台灣海峽', '太平洋外海'],
